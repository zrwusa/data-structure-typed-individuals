![NPM](https://img.shields.io/npm/l/max-priority-queue-typed)
![GitHub top language](https://img.shields.io/github/languages/top/zrwusa/data-structure-typed)
![npm](https://img.shields.io/npm/dw/max-priority-queue-typed)
![eslint](https://aleen42.github.io/badges/src/eslint.svg)
![npm package minimized gzipped size (select exports)](https://img.shields.io/bundlejs/size/max-priority-queue-typed)
![npm bundle size](https://img.shields.io/bundlephobia/min/max-priority-queue-typed)
